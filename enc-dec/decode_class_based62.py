...
class MobileMessage:
	...
	def message_decoder(self):
		...
		self.power1 = math.log(self.mobile_number1, 62)
		print "\nlog(",self.mobile_number1,"2)", " = ", self.power1

		self.power2 = math.log(self.mobile_number2, 62)
	...
	def message_encoder(self):
		...
		print "pow(2,", self.power1,") = ", math.pow(62, self.power1)

		# mobile_number2 = 2**power2
		print "pow(2,", self.power2,") = ", math.pow(62, self.power2)
